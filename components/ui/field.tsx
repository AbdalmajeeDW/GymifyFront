...
const fieldVariants = cva("group/field flex w-full text-gray-700", {
  variants: {
    orientation: {
...
function FieldLabel({
  ...
  return (
    <Label
      ...
      className={cn(
        "group/field-label  mb-1 peer/field-label flex w-fit gap-2 leading-snug group-data-[disabled=true]/field:opacity-50",
